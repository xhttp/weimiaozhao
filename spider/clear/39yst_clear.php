...
Host:img.39yst.com
Referer:http://www.39yst.com/weixin/201501/226124.shtml
Pragma:no-cache
...
echo $row['url'], "\n";
    ...
    $content = str_replace('alt="未标题-1"', 'alt="'.$row['title'].'"', $content);
    $content = str_replace('alt="未标题-2"', 'alt="'.$row['title'].'"', $content);
    $content = str_replace('alt="1"', 'alt="'.$row['title'].'"', $content);
    $content = str_replace('alt="2"', 'alt="'.$row['title'].'"', $content);
    $content = str_replace(' &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;', '', $content);
    $content = str_replace('&hellip;', '…', $content);
    $content = str_replace(' border="0"', '', $content);
    $content = str_replace(' width="400"', '', $content);
    $content = str_replace(' height="400"', '', $content);
    $content = str_replace(' style="border: 0px;"', '', $content);
    $content = preg_replace('/延伸阅读：(.*)/isU', '', $content);
